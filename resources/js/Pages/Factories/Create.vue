                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Nombre de la Fábrica" v-model="factoryForm.name">
                            <div v-if="$page.props.errors.name" class="text-red-500">{{ $page.props.errors.name }}</div>
                        </div>
                        <div class="mb-4">
                            <label for="exampleFormControlInput2" class="block text-gray-700 text-sm font-bold mb-2">Teléfono de Contacto:</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput2" v-model="factoryForm.phone_number" placeholder="Teléfono de Contacto de la Fábrica"/>
...
export default {
    ...
    methods:{
        store(){
            this.factoryForm.post(route('factories.store'),{
